...
#define STRING_CONFIG_H_AUTHOR "(Tijn Coertjens)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Leapfrog Mod van Tinus"
 ...
 */
#define S_CURVE_ACCELERATION     //FF TESTEN !!!!!!!!!!!!!!!
